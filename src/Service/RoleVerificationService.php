...
class RoleVerificationService
{
    ...
    private function parseNamesFromText(string $text): array
    {
        ...
        // Role extraction: accept variations like "Role", "ROLE", "Role Name", "Badge", "Position", "Title"
        if (
            ...
            // Fallback: scan for known role tokens anywhere in the text
    ...
    private function extractNames(string $path, ?string $originalName = null): array
    {
        ...
        // Fallback: try to infer names from original file name when OCR is not configured/available
